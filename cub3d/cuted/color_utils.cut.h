...
*/
static t_info_rule				g_rlbk[CNT_RULE];

/*
** Global constant array pointer to getter-functions
*/
static const t_getter_clr	g_getclr[CNT_TYPE_RULE] = {
	base_clr,
	setted_clr,
	texture_clr
};
...
*/
static const t_uint			g_pallete_base_color[CNT_BASE_COLOR] = {
	0x000000,
	0xC0C0C0,
	0x808080,
	0x000000,
